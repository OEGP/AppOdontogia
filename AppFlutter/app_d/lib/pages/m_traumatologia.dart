...
class m_trauma extends StatefulWidget {
  const m_trauma ({super.key});

  @override
  State<m_trauma> createState() => m_traumaState();
}

class m_traumaState extends State<m_trauma > {
